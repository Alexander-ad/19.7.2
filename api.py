...
class PetFriends:
    ...
    def delete_pet(self, auth_key: json, pet_id: str) -> json:
        """Метод отправляет на сервер запрос удаления питомца по ID и возвращает
        статус и результат запроса в формате JSON"""
    ...
    def update_pet_info(self, auth_key: json, pet_id: str, name: str,
        ...
        """Метод отправляет запрос на сервер об обновлении данных питомуа по ID и
        возвращает статус и результат запроса в формате JSON"""
